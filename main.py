...
c1 = Column(80, 10, 10, SMALL) # Creation of column object
...
def animate(i):
    ...
    [c1.U, c1.C, c1.Q, c1.Q2, c1.Q2L, c1.rho, c1.L, c1.nu_t, c1.Kz, c1.Kq, c1.N_BV, c1.N_BVsq] = wc_advance(c1, t_px, px0, t[i])
